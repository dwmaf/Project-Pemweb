<div class="tengah-lg-md " style="  
    background-size: 100% 100%; background-repeat: no-repeat; height: 888px; display: flex; flex-direction: column; justify-content: space-between; margin:10px">
